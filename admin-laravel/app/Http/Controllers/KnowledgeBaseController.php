...
class KnowledgeBaseController extends Controller
{
    ...
    public function uploadSource(Request $request, string $collectionId)
    {
        ...
        $validated = $request->validate([
            'file' => [
                ...
                // Images are read by the vision model set in admin settings.
                'mimes:pdf,docx,pptx,xlsx,xls,csv,md,txt,html,htm,png,jpg,jpeg,webp',
            ],
            'title' => ['nullable', 'string', 'max:500'],
            'description' => ['nullable', 'string', 'max:1000'],
        ], [
            'file.mimes' => 'That file type is not supported. Use PDF, Word, PowerPoint, Excel, CSV, Markdown, HTML, plain text, or a PNG, JPG or WebP image.',
    ...
    public function runPlayground(Request $request)
    {
        ...
        return view('kb.playground', [
            ...
            'reranked' => (bool) ($response['reranked'] ?? false),
        ]);
    }
