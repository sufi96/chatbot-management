{{-- Profile and Brain are two halves of one bot's settings. A tab each makes
     Brain read as part of the bot rather than as an action in the page head.
    ...
    <li class="nav-item">
        <a class="nav-link d-inline-flex align-items-center gap-1.5 {{ request()->routeIs('bots.brain') ? 'active' : '' }}"
           ...
           @if(request()->routeIs('bots.brain')) aria-current="page" @endif>
            <i class="bi bi-diagram-2"></i> Brain
        </a>
    </li>
</ul>
