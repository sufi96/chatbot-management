...
<div class="page-head mb-3" style="border-bottom: 0; padding-bottom: 0;">
    <div>
        ...
        <p>Written material the bots in {{ $activeSystem->name }} can answer from. A collection is a group of related documents; each bot chooses which collections it reads.</p>
    </div>
