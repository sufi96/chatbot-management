                ...
                <div class="card h-100">
                    ...
                    <div class="p-3">
                        <div class="row g-3">
                            ...
                            <div class="col-6 col-sm-3">
                                <label for="min_similarity" class="form-label">Similarity floor</label>
                                <input type="number" step="0.01" name="min_similarity" id="min_similarity"
                                       class="form-control font-monospace" min="0" max="1"
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-2 mb-1.5">
                                ...
                                <span class="d-flex gap-1">
                                    @if(isset($result['similarity']))
                                        <span class="chip figure-mono">similarity {{ number_format($result['similarity'], 3) }}</span>
                                    @endif
