    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-12 col-md-4">
            <button type="button" class="card w-100 h-100 text-start p-3"
                ...
                <div class="text-muted" style="font-size: 0.78125rem;">PDF, Word, Excel, CSV, Markdown or an image</div>
            </button>
        </div>
        <div class="col-12 col-md-4">
            <button type="button" class="card w-100 h-100 text-start p-3"
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="file" name="file" id="kb_file" class="form-control"
                                   accept=".pdf,.docx,.pptx,.xlsx,.xls,.csv,.md,.txt,.html,.htm,.png,.jpg,.jpeg,.webp" required>
                            <div class="form-text">
