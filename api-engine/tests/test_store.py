...
@pytest.mark.asyncio
async def test_make_store_follows_the_database(session):
    """This session is SQLite. See test_store_driver.py."""
    assert type(make_store(session)).__name__ == "SqliteVectorStore"
